...
public class ListViewAlarmItem {
    ...
    public ListViewAlarmItem(String alramName, String startAlram, String finishAlram, String oneTimeDose, Long alramGroupId, String doseType, String dosingPeriod) {
